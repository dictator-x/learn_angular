...
export const getPlayerState = createSelector(selectPlayerStates, (state: PlayState) => state);
...
export const getCurrentSong = createSelector(selectPlayerStates, ({ songList, currentIndex }: PlayState) => songList[currentIndex]);
